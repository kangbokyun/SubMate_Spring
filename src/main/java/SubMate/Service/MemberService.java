...
//						String filePath = "C:/Users/강보균/Desktop/SubMate_React/src/MemberImg";
				...
				String filePath = "C:/Users/bk940/OneDrive/바탕 화면/SubMate_React/src/MemberImg";
//				String filePath = "C:/Users/강보균/Desktop/SubMate_React/src/MemberImg";
				memberDTO.setProfileimg(filePath + "User_No_Img.png");
			}
	...
	public boolean SignUpNoImg(MemberDTO memberDTO) {
		if(memberDTO != null) {
			if(memberDTO.getMplatform() == null || memberDTO.getMplatform().equals("SubMate")) {
				memberDTO.setMplatform("SubMate");
			}
			String noImg = "C:/Users/bk940/OneDrive/바탕 화면/SubMate_React/src/MemberImg";
//			String noImg = "C:/Users/강보균/Desktop/SubMate_React/src/MemberImg";
			memberDTO.setProfileimg(noImg + "User_No_Img.png");
			 if (memberDTO.getMplatform().equals("SubMate")) {
				// 나이대
				Date date = new Date();
				SimpleDateFormat sdf = new SimpleDateFormat("YYYY");
				String ager = "";
